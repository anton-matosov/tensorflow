...
class MklConv2DOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* context) override {
    ...
    size_t filter_sizes[4] = {static_cast<size_t>(filter.dim_size(0)), static_cast<size_t>(filter.dim_size(1)),
                              static_cast<size_t>(filter.dim_size(2)), static_cast<size_t>(filter.dim_size(3))};
